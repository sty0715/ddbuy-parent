...
<div class="top">
    ...
    <div class="search">
    	<form onsubmit="goPage(1);" action="search" id="searchForm" name="searchForm" method="post">
        	<input type="text" value="${title}" class="s_ipt" name="title" />
            <!--保存页码-->
            <input type="hidden" id="pageNum" value="${pageNum}" class="s_ipt" name="pageNum" />
            ...
            <div class="list_c">
                ...
                <ul class="cate_list">
                    <c:forEach items="${map.rows}" var="p">
                        <li>
                            <div class="img"><a target="_blank" href="http://localhost:80/${p.pid}.html"><img src="images/per_1.jpg" width="210" height="185" /></a></div>
                            <div class="price">
